...
|---|---|---|---|
| U0 | `tela-s5-u0-english-adoption-naming-cleanup` | 0 (pre-admission) | Stage 4 landed baseline; convention = operator English-first (2026-08-09) + council-review-2026-08-09-cto-naming.md |
| U1 | `tela-s5-u1-discovery-reference-posture` | 1 | U0 |
...
### U0 — `tela-s5-u0-english-adoption-naming-cleanup` (pre-admission)
...
| `non_goals` | No new reference families (U2+). No radix-lane fixes (codgen001/prim-nullable/verum are separate residuals). No executed-lane orchestration (U9 + follow-on goal). No faber-web seam changes. |
